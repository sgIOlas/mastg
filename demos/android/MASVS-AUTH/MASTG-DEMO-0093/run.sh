#!/bin/bash
NO_COLOR=true semgrep -c ../../../../rules/mastg-android-biometric-validity-duration.yml ../MASTG-DEMO-0090/MastgTest_reversed.java --text | sed -r "s/\x1B\[([0-9]{1,3}(;[0-9]{1,2})?)?[mGK]//g" > output.txt
