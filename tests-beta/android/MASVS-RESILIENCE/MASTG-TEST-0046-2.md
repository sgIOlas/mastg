...
2. Use @MASTG-TECH-0013 and the following techniques to try to statically identify indicators of native debugging checks as shown in @MASTG-KNOW-0028:
   ...
   3. Checks implemented in native libraries using [inlined system calls](https://medium.com/@axhlzy/android-reverse-engineering-basics-syscalls-and-inline-assembly-27587365f329) (@MASTG-TECH-0018 and @MASTG-TECH-0071).
